...
// //         {/* <img
// //           src={writer.writerimage ? `http://localhost:5000/uploads/${writer.image}` : img1}
// //           alt="Writer"
...
// // import SharesButton from "../components/SharesButton";

// const WriterProfile = () => {
//   const { id } = useParams(); // <-- get writerId from URL
...
//         `http://localhost:5500/api/admin/get-writer-by-id/${id}`, // <-- use writerId
//         { withCredentials: true }
//       );
//       if (res.data.success) {
//         setWriter({
...
//       if (interval.current) clearInterval(interval.current);
//     };
//   }, [id]); // refetch if writerId changes
